...
const Nav = () => {
  ...
  return (
    <div className={`${show && "bg-black"} fixed top-0 pt-4 w-full h-16 z-10 ease-in transition-all duration-500`}>
      <div className="flex justify-between">
        <img
          src={Logo}
          alt=""
          className="fixed top-2 left-0 w-20 object-contain pl-1 cursor-pointer"
        />
        <img
